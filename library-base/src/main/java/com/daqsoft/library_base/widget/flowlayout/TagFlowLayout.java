package com.daqsoft.library_base.widget.flowlayout;
...
public class TagFlowLayout extends FlowLayout
    ...
    public interface OnMoreClickListener {
        boolean onMoreClick(View view, FlowLayout parent);
    }
    ...
    public void setAdapter(TagAdapter adapter) {
        ...
        mSelectedView.clear();
        mNeedMore = adapter.showMoreView(this);
        changeAdapter();
    }
    ...
    private void changeAdapter() {
        ...
        View mMoreView = adapter.getMoreView(this);
        if (mNeedMore && mMoreView != null) {
            tagViewContainer = new TagView(getContext());
            mMoreView.setDuplicateParentStateEnabled(true);
            if (mMoreView.getLayoutParams() != null) {
                tagViewContainer.setLayoutParams(mMoreView.getLayoutParams());
            } else {
                MarginLayoutParams lp = new MarginLayoutParams(
                        LayoutParams.WRAP_CONTENT,
                        LayoutParams.WRAP_CONTENT);
            ...
            tagViewContainer.addView(mMoreView);
            addView(tagViewContainer);
            ...
            tagViewContainer.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mOnMoreClickListener != null) {
                        mOnMoreClickListener.onMoreClick(finalTagViewContainer1, TagFlowLayout.this);
                    }
                }
            });
            addMoreView(true, tagViewContainer);
        }
    ...
    public void setmNeedMore(boolean mNeedMore) {
        this.mNeedMore = mNeedMore;
        if (!mNeedMore){
            addMoreView(false,null);
        }
    }
}
